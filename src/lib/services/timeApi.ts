...
// Define interfaces for the timeapi.io responses
...
// Function to fetch current time from timeapi.io
export async function fetchCurrentTime(timeZone = "UTC"): Promise<TimeApiResponse> {
  try {
